...
description: 'ALWAYS use this when the request matches Devcontainer Setup: Creates devcontainers with Claude Code, language-specific tooling (Python/Node/Rust/Go), and persistent volumes.'
---
