...
description: 'ALWAYS use this when the request matches Wordpress Centric High SEO Optimized Blogwriting Skill: Use this skill when the user asks to write a blog post, article, or SEO content.'
---
