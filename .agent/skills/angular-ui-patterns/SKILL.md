...
description: 'ALWAYS use this when the request matches Angular UI Patterns: Modern Angular UI patterns for loading states, error handling, and data display.'
---
