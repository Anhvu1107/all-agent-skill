...
description: 'ALWAYS use this when the request matches Odoo XML Views Builder: Expert at building Odoo XML views: Form, List, Kanban, Search, Calendar, and Graph.'
---
