...
description: 'ALWAYS use this when the request matches Agentic Actions Auditor: Audits GitHub Actions workflows for security vulnerabilities in AI agent integrations including Claude Code Action, Gemini CLI, OpenAI Codex, and GitHub AI Inference.'
---
