---
name: flutter-expert
description: 'ALWAYS use this when the request matches Flutter Expert: Master Flutter development with Dart 3, advanced widgets, and multi-platform deployment.'
---
