...
description: 'ALWAYS use this when the request matches SEO Cannibalization Detector: Analyzes multiple provided pages to identify keyword overlap and potential cannibalization issues.'
---
