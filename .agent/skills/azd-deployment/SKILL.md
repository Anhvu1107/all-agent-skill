---
name: azd-deployment
description: 'ALWAYS use this when the request matches AZD Deployment: Deploy containerized frontend + backend applications to Azure Container Apps with remote builds, managed identity, and idempotent infrastructure.'
---
