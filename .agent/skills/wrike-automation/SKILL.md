...
description: 'ALWAYS use this when the request matches Wrike Automation: Automate Wrike project management via Rube MCP (Composio): create tasks/folders, manage projects, assign work, and track progress.'
---
