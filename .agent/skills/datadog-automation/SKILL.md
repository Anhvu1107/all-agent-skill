...
description: 'ALWAYS use this when the request matches Datadog Automation: Automate Datadog tasks via Rube MCP (Composio): query metrics, search logs, manage monitors/dashboards, create events and downtimes.'
---
