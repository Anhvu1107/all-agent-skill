...
description: 'ALWAYS use this when the request matches Sales Enablement: Create sales collateral such as decks, one-pagers, objection docs, demo scripts, playbooks, and proposal templates.'
---
