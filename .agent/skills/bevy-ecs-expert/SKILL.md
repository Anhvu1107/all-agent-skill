...
description: 'ALWAYS use this when the request matches Bevy ECS Expert: Master Bevy''s Entity Component System (ECS) in Rust, covering Systems, Queries, Resources, and parallel scheduling.'
---
