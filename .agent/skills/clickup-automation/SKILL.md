...
description: 'ALWAYS use this when the request matches Clickup Automation: Automate ClickUp project management including tasks, spaces, folders, lists, comments, and team operations via Rube MCP (Composio).'
---
