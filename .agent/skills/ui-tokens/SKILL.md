---
name: ui-tokens
description: 'ALWAYS use this when the request matches UI Tokens: List, add, and update StyleSeed design tokens while keeping JSON sources, CSS variables, and dark-mode values in sync.'
---
