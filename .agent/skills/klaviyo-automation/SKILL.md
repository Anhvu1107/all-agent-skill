...
description: 'ALWAYS use this when the request matches Klaviyo Automation: Automate Klaviyo tasks via Rube MCP (Composio): manage email/SMS campaigns, inspect campaign messages, track tags, and monitor send jobs.'
---
