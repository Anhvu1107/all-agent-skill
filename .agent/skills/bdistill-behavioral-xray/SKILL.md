...
description: 'ALWAYS use this when the request matches Bdistill Behavioral Xray: X-ray any AI model''s behavioral patterns — refusal boundaries, hallucination tendencies, reasoning style, formatting defaults.'
---
