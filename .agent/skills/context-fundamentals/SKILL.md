...
description: 'ALWAYS use this when the request matches Context Fundamentals: Context is the complete state available to a language model at inference time.'
---
