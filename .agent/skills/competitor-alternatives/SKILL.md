...
description: 'ALWAYS use this when the request matches Competitor Alternatives: You are an expert in creating competitor comparison and alternative pages.'
---
