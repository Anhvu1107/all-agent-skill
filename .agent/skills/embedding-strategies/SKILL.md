...
description: 'ALWAYS use this when the request matches Embedding Strategies: Guide to selecting and optimizing embedding models for vector search applications.'
---
