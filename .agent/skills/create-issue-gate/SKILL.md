...
description: 'ALWAYS use this when the request matches Create Issue Gate: Use when starting a new implementation task and an issue must be created with strict acceptance criteria gating before execution.'
---
