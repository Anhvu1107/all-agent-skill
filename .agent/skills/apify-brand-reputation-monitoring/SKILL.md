...
description: 'ALWAYS use this when the request matches Apify Brand Reputation Monitoring: Scrape reviews, ratings, and brand mentions from multiple platforms using Apify Actors.'
---
