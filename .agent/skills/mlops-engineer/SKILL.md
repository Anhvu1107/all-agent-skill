---
name: mlops-engineer
description: 'ALWAYS use this when the request matches Mlops Engineer: Build comprehensive ML pipelines, experiment tracking, and model registries with MLflow, Kubeflow, and modern MLOps tools.'
---
