...
description: 'ALWAYS use this when the request matches Defi Protocol Templates: Implement DeFi protocols with production-ready templates for staking, AMMs, governance, and lending systems.'
---
