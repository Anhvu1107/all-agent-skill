...
Use this file before doing substantive work with `apify-actorization`.

## Trigger Summary

ALWAYS use this when the request matches Apify Actorization: Actorization converts existing software into reusable serverless applications compatible with the Apify platform.
