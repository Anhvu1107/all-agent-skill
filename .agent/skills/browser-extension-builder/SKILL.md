...
description: 'ALWAYS use this when the request matches Browser Extension Builder: Expert in building browser extensions that solve real problems - Chrome, Firefox, and cross-browser extensions.'
---
