...
Use this file before doing substantive work with `documentation-templates`.

## Trigger Summary

ALWAYS use this when the user needs structured technical docs, runbooks, RFCs, checklists, onboarding docs, or repeatable document shapes instead of ad-hoc prose.
