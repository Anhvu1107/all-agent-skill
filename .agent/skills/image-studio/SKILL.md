---
name: image-studio
description: 'ALWAYS use this when the request matches Image Studio: Studio de geracao de imagens inteligente — roteamento automatico entre ai-studio-image (fotos humanizadas/influencer) e stability-ai (arte/ ilustracao/edicao).'
---
