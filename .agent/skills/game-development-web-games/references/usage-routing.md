...
Use this file before doing substantive work with `game-development-web-games`.

## Trigger Summary

ALWAYS use this when the user or an upstream archive refers to `game-development-web-games`, the nested skill path form for `web-games`, or the equivalent slash path. This is a namespace-preserving alias that routes to `web-games` while retaining strict validation, Senior Master execution, and Codex review standards.
