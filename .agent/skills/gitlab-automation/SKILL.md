...
description: 'ALWAYS use this when the request matches Gitlab Automation: Automate GitLab project management, issues, merge requests, pipelines, branches, and user operations via Rube MCP (Composio).'
---
