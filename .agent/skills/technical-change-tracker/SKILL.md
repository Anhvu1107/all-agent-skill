...
description: 'ALWAYS use this when the request matches Technical Change Tracker: Track code changes with structured JSON records, state machine enforcement, and AI session handoff for bot continuity'
---
