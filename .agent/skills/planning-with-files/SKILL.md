...
description: 'ALWAYS use this when the request matches Planning With Files: Work like Manus: Use persistent markdown files as your "working memory on disk.'
---
...
- **Manus Principles:** See [reference.md](references/legacy-reference.md)
- **Real Examples:** See [examples.md](references/legacy-examples.md)
