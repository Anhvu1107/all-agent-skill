...
description: 'ALWAYS use this when the request matches Airtable Automation: Automate Airtable tasks via Rube MCP (Composio): records, bases, tables, fields, views.'
---
