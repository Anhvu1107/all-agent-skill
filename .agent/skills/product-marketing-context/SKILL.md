...
description: 'ALWAYS use this when the request matches Product Marketing Context: Create or update a reusable product marketing context document with positioning, audience, ICP, use cases, and messaging.'
---
