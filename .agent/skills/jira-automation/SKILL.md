...
description: 'ALWAYS use this when the request matches Jira Automation: Automate Jira tasks via Rube MCP (Composio): issues, projects, sprints, boards, comments, users.'
---
