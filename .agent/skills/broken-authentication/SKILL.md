...
description: 'ALWAYS use this when the request matches Broken Authentication: Identify and exploit authentication and session management vulnerabilities in web applications.'
---
