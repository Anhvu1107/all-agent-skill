...
Use this file before doing substantive work with `cold-email`.

## Trigger Summary

ALWAYS use this when the request matches Cold Email: Write B2B cold emails and follow-up sequences that earn replies.
