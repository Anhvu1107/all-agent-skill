...
description: 'ALWAYS use this when the request matches GIT Hooks Automation: Master Git hooks setup with Husky, lint-staged, pre-commit framework, and commitlint.'
---
