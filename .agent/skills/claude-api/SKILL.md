---
name: claude-api
description: 'ALWAYS use this when the request matches Claude API: Build, debug, and optimize Claude API / Anthropic SDK apps.'
---
...
Then read only the language folder or shared docs that match the target project.
