...
Use this file before doing substantive work with `claude-api`.

## Trigger Summary

ALWAYS use this when the request matches Claude API: Build, debug, and optimize Claude API / Anthropic SDK apps.
