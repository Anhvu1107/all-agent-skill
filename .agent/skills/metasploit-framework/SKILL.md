...
description: 'ALWAYS use this when the request matches Metasploit Framework: ⚠️ AUTHORIZED USE ONLY > This skill is for educational purposes or authorized security assessments only.'
---
