...
description: 'ALWAYS use this when the request matches Azure Search Documents TS: Build search applications with vector, hybrid, and semantic search capabilities.'
---
