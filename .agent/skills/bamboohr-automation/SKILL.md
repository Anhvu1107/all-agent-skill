...
description: 'ALWAYS use this when the request matches Bamboohr Automation: Automate BambooHR tasks via Rube MCP (Composio): employees, time-off, benefits, dependents, employee updates.'
---
