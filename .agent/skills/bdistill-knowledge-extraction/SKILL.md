...
description: 'ALWAYS use this when the request matches Bdistill Knowledge Extraction: Extract structured domain knowledge from AI models in-session or from local open-source models via Ollama.'
---
