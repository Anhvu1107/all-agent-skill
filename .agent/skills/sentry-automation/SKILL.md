...
description: 'ALWAYS use this when the request matches Sentry Automation: Automate Sentry tasks via Rube MCP (Composio): manage issues/events, configure alerts, track releases, monitor projects and teams.'
---
