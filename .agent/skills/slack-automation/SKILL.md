...
description: 'ALWAYS use this when the request matches Slack Automation: Automate Slack workspace operations including messaging, search, channel management, and reaction workflows through Composio''s Slack toolkit.'
---
