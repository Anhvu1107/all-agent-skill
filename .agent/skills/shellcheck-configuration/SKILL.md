...
description: 'ALWAYS use this when the request matches Shellcheck Configuration: Master ShellCheck static analysis configuration and usage for shell script quality.'
---
