...
- [SKILL_RULES_REFERENCE.md](legacy-skill-rules-reference.md) - Complete skill-rules.json schema
- [PATTERNS_LIBRARY.md](legacy-patterns-library.md) - Ready-to-use pattern library
