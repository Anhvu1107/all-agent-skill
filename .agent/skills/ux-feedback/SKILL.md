---
name: ux-feedback
description: 'ALWAYS use this when the request matches UX Feedback: Add loading, empty, error, and success feedback states to StyleSeed components and pages with practical mobile-first rules.'
---
