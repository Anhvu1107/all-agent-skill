...
description: 'ALWAYS use this when the request matches SEO Content Refresher: Identifies outdated elements in provided content and suggests updates to maintain freshness.'
---
