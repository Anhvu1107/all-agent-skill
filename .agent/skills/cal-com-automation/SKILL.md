...
description: 'ALWAYS use this when the request matches CAL COM Automation: Automate Cal.com tasks via Rube MCP (Composio): manage bookings, check availability, configure webhooks, and handle teams.'
---
