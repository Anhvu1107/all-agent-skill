...
Use this file before doing substantive work with `hugging-face-trackio`.

## Trigger Summary

ALWAYS use this when the request matches Hugging Face Trackio: Track ML experiments with Trackio using Python logging, alerts, and CLI metric retrieval.
