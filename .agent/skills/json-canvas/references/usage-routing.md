...
Use this file before doing substantive work with `json-canvas`.

## Trigger Summary

ALWAYS use this when the request matches Json Canvas: Create and edit JSON Canvas files (.canvas) with nodes, edges, groups, and connections.
