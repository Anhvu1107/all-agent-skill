...
description: 'ALWAYS use this when the request matches Azure AI Formrecognizer Java: Build document analysis applications using the Azure AI Document Intelligence SDK for Java.'
---
