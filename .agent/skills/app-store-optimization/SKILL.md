...
description: ALWAYS use this when the user needs App Store or Google Play optimization, including ASO research, keyword strategy, listing copy, screenshots, launch prep, or store-performance analysis.
---
...
- `references/launch-review-checklist.md`

Then use `README.md` and `HOW_TO_USE.md` only when you need the longer operational walkthrough.
