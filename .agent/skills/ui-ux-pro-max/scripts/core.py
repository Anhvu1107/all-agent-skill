...
STACK_CONFIG = {
    ...
    "sveltekit": {"file": "stacks/sveltekit.csv"},
    "swiftui": {"file": "stacks/swiftui.csv"},
    "jetpack-compose": {"file": "stacks/jetpack-compose.csv"},
    "react-native": {"file": "stacks/react-native.csv"},
    "expo-router": {"file": "stacks/expo-router.csv"},
...
def detect_domain(query):
    ...
    domain_keywords = {
        ...
        "react": ["react", "next.js", "nextjs", "remix", "astro", "sveltekit", "expo router", "suspense", "memo", "useeffect", "rerender", "bundle", "dynamic import"],
        "web": ["aria", "focus", "outline", "semantic", "virtualize", "autocomplete", "form", "input type"]
    }

    scores = {domain: sum(1 for keyword in keywords if keyword in query_lower) for domain, keywords in domain_keywords.items()}
