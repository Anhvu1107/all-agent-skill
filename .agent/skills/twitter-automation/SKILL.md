...
description: 'ALWAYS use this when the request matches Twitter Automation: Automate Twitter/X tasks via Rube MCP (Composio): posts, search, users, bookmarks, lists, media.'
---
