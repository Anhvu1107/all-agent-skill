---
name: writer
description: 'ALWAYS use this when the request matches Writer: Document creation, format conversion (ODT/DOCX/PDF), mail merge, and automation with LibreOffice Writer.'
---
