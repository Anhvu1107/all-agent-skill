---
name: voice-agents
description: 'ALWAYS use this when the request matches Voice Agents: Voice agents represent the frontier of AI interaction - humans speaking naturally with AI systems.'
---
