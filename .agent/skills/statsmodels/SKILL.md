---
name: statsmodels
description: 'ALWAYS use this when the request matches Statsmodels: Statsmodels is Python''s premier library for statistical modeling, providing tools for estimation, inference, and diagnostics across a wide range of statistical methods.'
---
