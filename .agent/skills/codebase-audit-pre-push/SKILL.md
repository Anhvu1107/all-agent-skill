...
description: 'ALWAYS use this when the request matches Codebase Audit PRE Push: Deep audit before GitHub push: removes junk files, dead code, security holes, and optimization issues.'
---
