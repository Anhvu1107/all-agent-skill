...
description: 'ALWAYS use this when the request matches Threejs Animation: Three.js animation - keyframe animation, skeletal animation, morph targets, animation mixing.'
---
