...
Use this file before doing substantive work with `senior-frontend`.

## Trigger Summary

ALWAYS use this when the request matches Senior Frontend: Frontend development skill for React, Next.js, TypeScript, and Tailwind CSS applications.
