...
description: 'ALWAYS use this when the request matches Systems Programming Rust Project: You are a Rust project architecture expert specializing in scaffolding production-ready Rust applications.'
---
