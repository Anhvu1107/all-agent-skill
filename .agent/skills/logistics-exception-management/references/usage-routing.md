...
Use this file before doing substantive work with `logistics-exception-management`.

## Trigger Summary

ALWAYS use this when the request matches Logistics Exception Management: Codified expertise for handling freight exceptions, shipment delays, damages, losses, and carrier disputes.
