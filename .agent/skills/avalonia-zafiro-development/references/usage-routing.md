...
Use this file before doing substantive work with `avalonia-zafiro-development`.
...
- Root markdown docs found at generation time: `avalonia-reactive-rules.md`, `core-technical-skills.md`, `naming-standards.md`, `patterns.md`, `zafiro-shortcuts.md`
