...
description: 'ALWAYS use this when the request matches Pagerduty Automation: Automate PagerDuty tasks via Rube MCP (Composio): manage incidents, services, schedules, escalation policies, and on-call rotations.'
---
