...
See [INSTALLATION.md](legacy-installation.md) for other installation methods (Web, API Console, minimal curl install).
...
**[Full Acknowledgements](legacy-acknowledgements.md)** - Complete list of 50+ research papers, articles, and resources
