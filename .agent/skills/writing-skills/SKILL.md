---
name: writing-skills
description: 'ALWAYS use this when the request matches Writing Skills: Use when creating new skills, editing existing skills, or verifying skills work before deployment'
---
