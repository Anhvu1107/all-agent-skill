...
description: 'ALWAYS use this when the request matches Business Analyst: Master modern business analysis with AI-powered analytics, real-time dashboards, and data-driven insights.'
---
