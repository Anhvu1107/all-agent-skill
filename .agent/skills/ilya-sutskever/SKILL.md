---
name: ilya-sutskever
description: 'ALWAYS use this when the request matches Ilya Sutskever: Agente que simula Ilya Sutskever — co-fundador da OpenAI, ex-Chief Scientist, fundador da SSI.'
---
