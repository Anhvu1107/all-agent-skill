...
Use this file before doing substantive work with `monte-carlo-push-ingestion`.

## Trigger Summary

ALWAYS use this when the request matches Monte Carlo Push Ingestion: Expert guide for pushing metadata, lineage, and query logs to Monte Carlo from any data warehouse.
