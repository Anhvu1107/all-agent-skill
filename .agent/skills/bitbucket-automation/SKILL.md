...
description: 'ALWAYS use this when the request matches Bitbucket Automation: Automate Bitbucket repositories, pull requests, branches, issues, and workspace management via Rube MCP (Composio).'
---
