...
description: 'ALWAYS use this when the request matches Context Manager: Elite AI context engineering specialist mastering dynamic context management, vector databases, knowledge graphs, and intelligent memory systems.'
---
