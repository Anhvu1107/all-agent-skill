...
description: 'ALWAYS use this when the request matches Humanize Chinese: Detect and rewrite AI-like Chinese text with a practical workflow for scoring, humanization, academic AIGC reduction, and style conversion.'
---
