...
Use this file before doing substantive work with `hig-patterns`.

## Trigger Summary

ALWAYS use this when the request matches HIG Patterns: Apple Human Interface Guidelines interaction and UX patterns.
