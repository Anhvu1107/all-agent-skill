...
description: 'ALWAYS use this when the request matches Magic UI Generator: Utilizes Magic by 21st.dev to generate, compare, and integrate multiple production-ready UI component variations.'
---
