...
Use this file before doing substantive work with `quality-nonconformance`.

## Trigger Summary

ALWAYS use this when the request matches Quality Nonconformance: Codified expertise for quality control, non-conformance investigation, root cause analysis, corrective action, and supplier quality management in regulated manufacturing.
