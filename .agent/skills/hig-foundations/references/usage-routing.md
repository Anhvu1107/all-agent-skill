...
Use this file before doing substantive work with `hig-foundations`.

## Trigger Summary

ALWAYS use this when the request matches HIG Foundations: Apple Human Interface Guidelines design foundations.
