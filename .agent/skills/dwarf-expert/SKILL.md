---
name: dwarf-expert
description: 'ALWAYS use this when the request matches Dwarf Expert: Provides expertise for analyzing DWARF debug files and understanding the DWARF debug format/standard (v3-v5).'
---
