...
description: 'ALWAYS use this when the request matches Godot 4 Migration: Specialized guide for migrating Godot 3.x projects to Godot 4 (GDScript 2.0), covering syntax changes, Tweens, and exports.'
---
