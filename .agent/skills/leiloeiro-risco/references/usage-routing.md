...
Use this file before doing substantive work with `leiloeiro-risco`.

## Trigger Summary

ALWAYS use this when the request matches Leiloeiro Risco: Analise de risco em leiloes de imoveis.
