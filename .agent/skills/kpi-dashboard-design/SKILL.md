...
description: 'ALWAYS use this when the request matches KPI Dashboard Design: Comprehensive patterns for designing effective Key Performance Indicator (KPI) dashboards that drive business decisions.'
---
