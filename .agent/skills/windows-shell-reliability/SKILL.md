...
description: 'ALWAYS use this when the request matches Windows Shell Reliability: Reliable command execution on Windows: paths, encoding, and common binary pitfalls.'
---
