...
description: 'ALWAYS use this when the request matches Outlook Automation: Automate Outlook tasks via Rube MCP (Composio): emails, calendar, contacts, folders, attachments.'
---
