...
description: 'ALWAYS use this when the request matches AWS Penetration Testing: Provide comprehensive techniques for penetration testing AWS cloud environments.'
---
