...
description: 'ALWAYS use this when the request matches Puzzle Activity Planner: Plan puzzle-based activities for classrooms, parties, and events with pre-configured generator links'
---
