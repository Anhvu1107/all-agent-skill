...
Use this file before doing substantive work with `deployment-procedures`.

## Trigger Summary

ALWAYS use this when shipping, releasing, promoting environments, or planning a deployment flow where ordering and rollback safety matter.
