...
description: 'ALWAYS use this when the request matches Odoo Docker Deployment: Production-ready Docker and docker-compose setup for Odoo with PostgreSQL, persistent volumes, environment-based configuration, and Nginx reverse proxy.'
---
