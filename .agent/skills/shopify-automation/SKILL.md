...
description: 'ALWAYS use this when the request matches Shopify Automation: Automate Shopify tasks via Rube MCP (Composio): products, orders, customers, inventory, collections.'
---
