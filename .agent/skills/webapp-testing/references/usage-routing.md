...
Use this file before doing substantive work with `webapp-testing`.

## Trigger Summary

ALWAYS use this when the task involves browser automation, UI verification, DOM inspection, end-to-end checks, or reproducing a web bug in a running application.
