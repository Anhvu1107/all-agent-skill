---
name: os-scripting
description: 'ALWAYS use this when the request matches OS Scripting: Operating system and shell scripting troubleshooting workflow for Linux, macOS, and Windows.'
---
