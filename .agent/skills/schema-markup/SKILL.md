---
name: schema-markup
description: 'ALWAYS use this when the request matches Schema Markup: Design, validate, and optimize schema.org structured data for eligibility, correctness, and measurable SEO impact.'
---
