...
description: 'ALWAYS use this when the request matches Hugging Face Community Evals: Run local evaluations for Hugging Face Hub models with inspect-ai or lighteval.'
---
