...
description: 'ALWAYS use this when the request matches Monday Automation: Automate Monday.com work management including boards, items, columns, groups, subitems, and updates via Rube MCP (Composio).'
---
