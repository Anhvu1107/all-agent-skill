...
description: 'ALWAYS use this when the request matches Security Auditor: Expert security auditor specializing in DevSecOps, comprehensive cybersecurity, and compliance frameworks.'
---
