...
description: 'ALWAYS use this when the request matches Azure AI Vision Imageanalysis PY: Azure AI Vision Image Analysis SDK for captions, tags, objects, OCR, people detection, and smart cropping.'
---
