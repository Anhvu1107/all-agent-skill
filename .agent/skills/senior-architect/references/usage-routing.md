...
Use this file before doing substantive work with `senior-architect`.

## Trigger Summary

ALWAYS use this when the request matches Senior Architect: Complete toolkit for senior architect with modern tools and best practices.
