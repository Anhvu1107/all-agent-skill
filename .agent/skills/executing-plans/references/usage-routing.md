...
Use this file before doing substantive work with `executing-plans`.

## Trigger Summary

ALWAYS use this when an approved plan, milestone list, or task sequence already exists and the job now is disciplined execution instead of strategy improvisation.
