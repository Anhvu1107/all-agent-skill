---
name: ui-a11y
description: 'ALWAYS use this when the request matches UI A11y: Audit a StyleSeed-based component or page for WCAG 2.2 AA issues and apply practical accessibility fixes where the code makes them safe.'
---
