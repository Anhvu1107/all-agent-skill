...
description: 'ALWAYS use this when the request matches Discord Automation: Automate Discord tasks via Rube MCP (Composio): messages, channels, roles, webhooks, reactions.'
---
