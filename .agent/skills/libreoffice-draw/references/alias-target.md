...
`libreoffice-draw` is a namespace-preserving alias for canonical skill `draw`.
...
- Canonical target folder: `.agent/skills/draw/`
- Canonical display name: Draw
- Alias display name: Libreoffice Draw
