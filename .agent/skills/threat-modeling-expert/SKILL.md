...
description: 'ALWAYS use this when the request matches Threat Modeling Expert: Expert in threat modeling methodologies, security architecture review, and risk assessment.'
---
