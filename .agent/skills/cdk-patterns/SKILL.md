---
name: cdk-patterns
description: 'ALWAYS use this when the request matches CDK Patterns: Common AWS CDK patterns and constructs for building cloud infrastructure with TypeScript, Python, or Java.'
---
