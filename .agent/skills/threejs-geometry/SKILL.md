...
description: 'ALWAYS use this when the request matches Threejs Geometry: Three.js geometry creation - built-in shapes, BufferGeometry, custom geometry, instancing.'
---
