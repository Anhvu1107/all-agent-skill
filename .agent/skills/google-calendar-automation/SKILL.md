...
description: 'ALWAYS use this when the request matches Google Calendar Automation: Lightweight Google Calendar integration with standalone OAuth authentication.'
---
