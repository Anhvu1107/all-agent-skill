---
name: e2e-testing
description: 'ALWAYS use this when the request matches E2e Testing: End-to-end testing workflow with Playwright for browser automation, visual regression, cross-browser testing, and CI/CD integration.'
---
