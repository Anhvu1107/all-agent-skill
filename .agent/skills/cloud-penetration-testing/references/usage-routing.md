...
Use this file before doing substantive work with `cloud-penetration-testing`.

## Trigger Summary

ALWAYS use this when the request matches Cloud Penetration Testing: Conduct comprehensive security assessments of cloud infrastructure across Microsoft Azure, Amazon Web Services (AWS), and Google Cloud Platform (GCP).
