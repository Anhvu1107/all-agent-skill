---
name: java-pro
description: 'ALWAYS use this when the request matches Java PRO: Master Java 21+ with modern features like virtual threads, pattern matching, and Spring Boot 3.x.'
---
