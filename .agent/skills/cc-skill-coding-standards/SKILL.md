...
description: 'ALWAYS use this when the request matches CC Skill Coding Standards: Universal coding standards, best practices, and patterns for TypeScript, JavaScript, React, and Node.js development.'
---
