---
name: ux-copy
description: 'ALWAYS use this when the request matches UX Copy: Generate UX microcopy in StyleSeed''s Toss-inspired voice for buttons, empty states, errors, toasts, confirmations, and form guidance.'
---
