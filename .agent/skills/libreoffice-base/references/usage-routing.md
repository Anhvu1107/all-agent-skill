...
Use this file before doing substantive work with `libreoffice-base`.

## Trigger Summary

ALWAYS use this when the user or an upstream archive refers to `libreoffice-base`, the nested skill path form for `base`, or the equivalent slash path. This is a namespace-preserving alias that routes to `base` while retaining strict validation, Senior Master execution, and Codex review standards.
