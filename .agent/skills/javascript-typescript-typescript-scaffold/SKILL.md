...
description: 'ALWAYS use this when the request matches Javascript Typescript Typescript Scaffold: You are a TypeScript project architecture expert specializing in scaffolding production-ready Node.js and frontend applications.'
---
