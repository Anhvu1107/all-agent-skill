...
Use this file before doing substantive work with `hig-components-dialogs`.

## Trigger Summary

ALWAYS use this when the request matches HIG Components Dialogs: Apple HIG guidance for presentation components including alerts, action sheets, popovers, sheets, and digit entry views.
