...
Use this file before doing substantive work with `postgres-best-practices`.

## Trigger Summary

ALWAYS use this when the request matches Postgres Best Practices: Postgres performance optimization and best practices from Supabase.
...
- Root markdown docs found at generation time: `AGENTS.md`, `README.md`
