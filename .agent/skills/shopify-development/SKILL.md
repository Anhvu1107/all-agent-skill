...
description: 'ALWAYS use this when the request matches Shopify Development: Build Shopify apps, extensions, themes using GraphQL Admin API, Shopify CLI, Polaris UI, and Liquid.'
---
