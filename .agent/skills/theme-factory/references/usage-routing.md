...
Use this file before doing substantive work with `theme-factory`.

## Trigger Summary

ALWAYS use this when the task is to pick or apply a coherent visual theme across slides, docs, reports, landing pages, or other styled artifacts rather than designing colors and fonts from scratch each time.
