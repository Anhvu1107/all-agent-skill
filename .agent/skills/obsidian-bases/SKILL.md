---
name: obsidian-bases
description: 'ALWAYS use this when the request matches Obsidian Bases: Create and edit Obsidian Bases (.base files) with views, filters, formulas, and summaries.'
---
