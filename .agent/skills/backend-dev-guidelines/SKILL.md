...
description: ALWAYS use this when implementing or reviewing backend routes, controllers, services, repositories, middleware, validation, or data-access layers in a production-style Node.js/TypeScript service.
---
