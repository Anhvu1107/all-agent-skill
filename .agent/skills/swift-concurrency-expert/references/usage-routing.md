...
Use this file before doing substantive work with `swift-concurrency-expert`.

## Trigger Summary

ALWAYS use this when the request matches Swift Concurrency Expert: Review and fix Swift concurrency issues such as actor isolation and Sendable violations.
