...
description: 'ALWAYS use this when the request matches Dependency Upgrade: Master major dependency version upgrades, compatibility analysis, staged upgrade strategies, and comprehensive testing approaches.'
---
