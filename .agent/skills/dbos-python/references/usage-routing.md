...
Use this file before doing substantive work with `dbos-python`.

## Trigger Summary

ALWAYS use this when the request matches Dbos Python: Guide for building reliable, fault-tolerant Python applications with DBOS durable workflows.
...
- Root markdown docs found at generation time: `AGENTS.md`, `CLAUDE.md`
