...
description: 'ALWAYS use this when the request matches Azure Postgres TS: Connect to Azure Database for PostgreSQL Flexible Server from Node.js/TypeScript using the pg (node-postgres) package.'
---
