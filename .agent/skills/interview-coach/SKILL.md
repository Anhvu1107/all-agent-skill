...
description: 'ALWAYS use this when the request matches Interview Coach: Full job search coaching system — JD decoding, resume, storybank, mock interviews, transcript analysis, comp negotiation.'
---
