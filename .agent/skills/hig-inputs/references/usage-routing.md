...
Use this file before doing substantive work with `hig-inputs`.

## Trigger Summary

ALWAYS use this when the request matches HIG Inputs: Check for .claude/apple-design-context.md before asking questions.
