...
description: 'ALWAYS use this when the request matches Monorepo Architect: Expert in monorepo architecture, build systems, and dependency management at scale.'
---
