...
Use this file before doing substantive work with `churn-prevention`.

## Trigger Summary

ALWAYS use this when the request matches Churn Prevention: Reduce voluntary and involuntary churn with cancel flows, save offers, dunning, win-back tactics, and retention strategy.
