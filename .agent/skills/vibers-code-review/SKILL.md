...
description: 'ALWAYS use this when the request matches Vibers Code Review: Human review workflow for AI-generated GitHub projects with spec-based feedback, security review, and follow-up PRs from the Vibers service.'
---
