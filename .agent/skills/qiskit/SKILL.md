---
name: qiskit
description: 'ALWAYS use this when the request matches Qiskit: Qiskit is the world''s most popular open-source quantum computing framework with 13M+ downloads.'
---
