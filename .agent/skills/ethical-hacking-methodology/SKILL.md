...
description: 'ALWAYS use this when the request matches Ethical Hacking Methodology: Master the complete penetration testing lifecycle from reconnaissance through reporting.'
---
