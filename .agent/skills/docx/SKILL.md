---
name: docx
description: ALWAYS use this when the user needs a Word document created, edited, inspected, validated, templated, or transformed, including tracked changes, comments, formatting-preserving updates, XML-level edits, or polished .docx deliverables.
---
