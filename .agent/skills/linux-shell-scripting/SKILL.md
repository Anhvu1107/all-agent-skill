...
description: 'ALWAYS use this when the request matches Linux Shell Scripting: Provide production-ready shell script templates for common Linux system administration tasks including backups, monitoring, user management, log analysis, and automation.'
---
