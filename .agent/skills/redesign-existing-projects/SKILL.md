...
description: 'ALWAYS use this when the request matches Redesign Existing Projects: Use when upgrading existing websites or apps by auditing generic UI patterns and applying premium design fixes without rewrites.'
---
