...
Use this file before doing substantive work with `receiving-code-review`.

## Trigger Summary

ALWAYS use this when review feedback arrives and you need to verify, triage, and implement it carefully instead of agreeing performatively or applying it blindly.
