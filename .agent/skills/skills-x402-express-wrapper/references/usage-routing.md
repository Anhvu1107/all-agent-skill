...
Use this file before doing substantive work with `skills-x402-express-wrapper`.

## Trigger Summary

ALWAYS use this when the user or an upstream archive refers to `skills-x402-express-wrapper`, the nested skill path form for `x402-express-wrapper`, or the equivalent slash path. This is a namespace-preserving alias that routes to `x402-express-wrapper` while retaining strict validation, Senior Master execution, and Codex review standards.
