...
description: 'ALWAYS use this when the request matches Burpsuite Project Parser: Searches and explores Burp Suite project files (.burp) from the command line.'
---
