...
Use this file before doing substantive work with `lead-magnets`.

## Trigger Summary

ALWAYS use this when the request matches Lead Magnets: Plan and optimize lead magnets for email capture and lead generation.
