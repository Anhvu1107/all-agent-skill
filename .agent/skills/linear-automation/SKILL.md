...
description: 'ALWAYS use this when the request matches Linear Automation: Automate Linear tasks via Rube MCP (Composio): issues, projects, cycles, teams, labels.'
---
