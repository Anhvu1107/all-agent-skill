...
description: 'ALWAYS use this when the request matches Azure Communication Chat Java: Build real-time chat applications with thread management, messaging, participants, and read receipts.'
---
