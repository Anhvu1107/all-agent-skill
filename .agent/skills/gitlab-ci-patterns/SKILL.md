...
description: 'ALWAYS use this when the request matches Gitlab CI Patterns: Comprehensive GitLab CI/CD pipeline patterns for automated testing, building, and deployment.'
---
