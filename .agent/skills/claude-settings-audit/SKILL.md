...
description: 'ALWAYS use this when the request matches Claude Settings Audit: Analyze a repository to generate recommended Claude Code settings.json permissions.'
---
