...
Use this file before doing substantive work with `skill-installer`.

## Trigger Summary

ALWAYS use this when the request matches Skill Installer: Instala, valida, registra e verifica novas skills no ecossistema.
