---
name: agents-md
description: 'ALWAYS use this when the request matches Agents MD: This skill should be used when the user asks to "create AGENTS.md", "update AGENTS.md", "maintain agent docs", "set up CLAUDE.md", or needs to keep agent instructions concise.'
---
