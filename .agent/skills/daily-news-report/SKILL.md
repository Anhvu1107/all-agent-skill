...
description: 'ALWAYS use this when the request matches Daily News Report: Scrapes content based on a preset URL list, filters high-quality technical information, and generates daily Markdown reports.'
---
