---
name: last30days
description: ALWAYS use this when the user wants very recent signal from the last 30 days across Reddit, X, and the web, especially for recommendations, trend checks, prompting techniques, or current-topic research.
---
...
Then read `README.md`, `SPEC.md`, or `TASKS.md` only if the request needs deeper implementation or output-shape detail.
