...
description: 'ALWAYS use this when the request matches Social Orchestrator: Orquestrador unificado de canais sociais — coordena Instagram, Telegram e WhatsApp em um unico fluxo de trabalho.'
---
