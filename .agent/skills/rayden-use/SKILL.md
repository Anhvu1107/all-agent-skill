---
name: rayden-use
description: 'ALWAYS use this when the request matches Rayden USE: Build and maintain Rayden UI components and screens in Figma via Figma MCP with full design token enforcement'
---
