...
description: 'ALWAYS use this when the request matches SEO Authority Builder: Analyzes content for E-E-A-T signals and suggests improvements to build authority and trust.'
---
