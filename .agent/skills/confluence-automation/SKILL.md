...
description: 'ALWAYS use this when the request matches Confluence Automation: Automate Confluence page creation, content search, space management, labels, and hierarchy navigation via Rube MCP (Composio).'
---
