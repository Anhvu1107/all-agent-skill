...
description: 'ALWAYS use this when the request matches Emblemai Crypto Wallet: Crypto wallet management across 7 blockchains via EmblemAI Agent Hustle API.'
---
