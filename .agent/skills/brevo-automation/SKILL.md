...
description: 'ALWAYS use this when the request matches Brevo Automation: Automate Brevo (formerly Sendinblue) email marketing operations through Composio''s Brevo toolkit via Rube MCP.'
---
