...
description: 'ALWAYS use this when the request matches Microsoft Azure Webjobs Extensions Authentication Events Dotnet: Microsoft Entra Authentication Events SDK for .NET.'
---
