...
description: 'ALWAYS use this when the request matches Hubspot Automation: Automate HubSpot CRM operations (contacts, companies, deals, tickets, properties) via Rube MCP using Composio integration.'
---
