...
description: 'ALWAYS use this when the request matches Amplitude Automation: Automate Amplitude tasks via Rube MCP (Composio): events, user activity, cohorts, user identification.'
---
