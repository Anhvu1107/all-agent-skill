...
description: 'ALWAYS use this when the request matches Googlesheets Automation: Automate Google Sheets operations (read, write, format, filter, manage spreadsheets) via Rube MCP (Composio).'
---
