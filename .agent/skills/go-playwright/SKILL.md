---
name: go-playwright
description: 'ALWAYS use this when the request matches GO Playwright: Expert capability for robust, stealthy, and efficient browser automation using Playwright Go.'
---
