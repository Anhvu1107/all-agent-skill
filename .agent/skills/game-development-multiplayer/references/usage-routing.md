...
Use this file before doing substantive work with `game-development-multiplayer`.

## Trigger Summary

ALWAYS use this when the user or an upstream archive refers to `game-development-multiplayer`, the nested skill path form for `multiplayer`, or the equivalent slash path. This is a namespace-preserving alias that routes to `multiplayer` while retaining strict validation, Senior Master execution, and Codex review standards.
