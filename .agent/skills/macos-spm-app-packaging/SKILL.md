...
description: 'ALWAYS use this when the request matches Macos SPM APP Packaging: Scaffold, build, sign, and package SwiftPM macOS apps without Xcode projects.'
---
