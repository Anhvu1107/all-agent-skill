...
description: 'ALWAYS use this when the request matches Pipecat Friday Agent: Build a low-latency, Iron Man-inspired tactical voice assistant (F.R.I.D.A.Y.) using Pipecat, Gemini, and OpenAI.'
---
