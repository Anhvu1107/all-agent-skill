...
description: 'ALWAYS use this when the request matches Vector Database Engineer: Expert in vector databases, embedding strategies, and semantic search implementation.'
---
