...
description: 'ALWAYS use this when the request matches Intercom Automation: Automate Intercom tasks via Rube MCP (Composio): conversations, contacts, companies, segments, admins.'
---
