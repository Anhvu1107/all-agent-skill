...
Use this file before doing substantive work with `leiloeiro-avaliacao`.

## Trigger Summary

ALWAYS use this when the request matches Leiloeiro Avaliacao: Avaliacao pericial de imoveis em leilao.
