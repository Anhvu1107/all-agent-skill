...
description: 'ALWAYS use this when the request matches Linkerd Patterns: Production patterns for Linkerd service mesh - the lightweight, security-first service mesh for Kubernetes.'
---
