...
description: 'ALWAYS use this when the request matches Youtube Automation: Automate YouTube tasks via Rube MCP (Composio): upload videos, manage playlists, search content, get analytics, and handle comments.'
---
