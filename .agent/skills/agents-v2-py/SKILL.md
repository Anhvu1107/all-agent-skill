---
name: agents-v2-py
description: 'ALWAYS use this when the request matches Agents V2 PY: Build container-based Foundry Agents with Azure AI Projects SDK (ImageBasedHostedAgentDefinition).'
---
