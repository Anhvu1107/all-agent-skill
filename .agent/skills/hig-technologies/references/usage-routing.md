...
Use this file before doing substantive work with `hig-technologies`.

## Trigger Summary

ALWAYS use this when the request matches HIG Technologies: Check for .claude/apple-design-context.md before asking questions.
