---
name: algolia-search
description: 'ALWAYS use this when the request matches Algolia Search: Expert patterns for Algolia search implementation, indexing strategies, React InstantSearch, and relevance tuning'
---
