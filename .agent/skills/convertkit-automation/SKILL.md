...
description: 'ALWAYS use this when the request matches Convertkit Automation: Automate ConvertKit (Kit) tasks via Rube MCP (Composio): manage subscribers, tags, broadcasts, and broadcast stats.'
---
