...
Use this file before doing substantive work with `content-strategy`.

## Trigger Summary

ALWAYS use this when the request matches Content Strategy: Plan a content strategy, topic clusters, editorial roadmap, and content mix for traffic, authority, and lead generation.
