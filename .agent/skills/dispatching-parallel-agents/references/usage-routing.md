...
Use this file before doing substantive work with `dispatching-parallel-agents`.

## Trigger Summary

ALWAYS use this when there are two or more independent investigations, failures, or implementation slices that can be worked in parallel without shared-state collisions.
