...
Use this file before doing substantive work with `junta-leiloeiros`.

## Trigger Summary

ALWAYS use this when the request involves Brazilian Junta Comercial auctioneer data, scraping leiloeiro records, querying the SQLite dataset, running the FastAPI API, or exporting these records to CSV/JSON.
