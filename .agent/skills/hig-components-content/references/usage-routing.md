...
Use this file before doing substantive work with `hig-components-content`.

## Trigger Summary

ALWAYS use this when the request matches HIG Components Content: Apple Human Interface Guidelines for content display components.
