...
Use this file before doing substantive work with `game-development-vr-ar`.

## Trigger Summary

ALWAYS use this when the user or an upstream archive refers to `game-development-vr-ar`, the nested skill path form for `vr-ar`, or the equivalent slash path. This is a namespace-preserving alias that routes to `vr-ar` while retaining strict validation, Senior Master execution, and Codex review standards.
