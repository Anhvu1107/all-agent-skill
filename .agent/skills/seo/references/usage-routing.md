...
Use this file before doing substantive work with `seo`.

## Trigger Summary

ALWAYS use this when the request matches SEO: Run a broad SEO audit across technical SEO, on-page SEO, schema, sitemaps, content quality, AI search readiness, and GEO.
