...
description: 'ALWAYS use this when the request matches ONE Drive Automation: Automate OneDrive file management, search, uploads, downloads, sharing, permissions, and folder operations via Rube MCP (Composio).'
---
