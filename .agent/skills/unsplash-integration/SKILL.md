...
description: 'ALWAYS use this when the request matches Unsplash Integration: Integration skill for searching and fetching high-quality, free-to-use professional photography from Unsplash.'
---
