...
description: 'ALWAYS use this when the request matches Google Slides Automation: Lightweight Google Slides integration with standalone OAuth authentication.'
---
