...
Use this file before doing substantive work with `nodejs-best-practices`.

## Trigger Summary

ALWAYS use this when implementing or reviewing Node.js application code, especially around runtime behavior, project structure, reliability, and server-side safety.
