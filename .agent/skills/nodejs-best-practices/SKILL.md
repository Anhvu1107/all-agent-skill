...
description: ALWAYS use this when implementing or reviewing Node.js application code, especially around runtime behavior, project structure, reliability, and server-side safety.
---
