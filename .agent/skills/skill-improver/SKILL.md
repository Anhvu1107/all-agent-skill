---
name: skill-improver
description: 'ALWAYS use this when the request matches Skill Improver: Iteratively improve a Claude Code skill using the skill-reviewer agent until it meets quality standards.'
---
