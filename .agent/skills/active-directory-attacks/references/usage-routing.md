...
Use this file before doing substantive work with `active-directory-attacks`.

## Trigger Summary

ALWAYS use this when the request matches Active Directory Attacks: Provide comprehensive techniques for attacking Microsoft Active Directory environments.
