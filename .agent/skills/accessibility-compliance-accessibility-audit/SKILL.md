...
description: 'ALWAYS use this when the request matches Accessibility Compliance Accessibility Audit: You are an accessibility expert specializing in WCAG compliance, inclusive design, and assistive technology compatibility.'
---
