...
description: 'ALWAYS use this when the request matches Scientific Writing: This is the core skill for the deep research and writing tool—combining AI-driven deep research with well-formatted written outputs.'
---
