...
Use this file before doing substantive work with `comfyui-gateway`.

## Trigger Summary

ALWAYS use this when the request matches Comfyui Gateway: REST API gateway for ComfyUI servers.
