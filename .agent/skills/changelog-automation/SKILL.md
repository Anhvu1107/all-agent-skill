...
description: 'ALWAYS use this when the request matches Changelog Automation: Automate changelog generation from commits, PRs, and releases following Keep a Changelog format.'
---
