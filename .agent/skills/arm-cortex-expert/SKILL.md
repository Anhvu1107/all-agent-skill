...
description: 'ALWAYS use this when the request matches ARM Cortex Expert: Senior embedded software engineer specializing in firmware and driver development for ARM Cortex-M microcontrollers (Teensy, STM32, nRF52, SAMD).'
---
