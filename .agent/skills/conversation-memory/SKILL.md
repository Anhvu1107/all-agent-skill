...
description: 'ALWAYS use this when the request matches Conversation Memory: Persistent memory systems for LLM conversations including short-term, long-term, and entity-based memory'
---
