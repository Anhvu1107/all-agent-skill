...
description: 'ALWAYS use this when the request matches Variant Analysis: Find similar vulnerabilities and bugs across codebases using pattern-based analysis.'
---
