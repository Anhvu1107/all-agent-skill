...
description: 'ALWAYS use this when the request matches Bullmq Specialist: BullMQ expert for Redis-backed job queues, background processing, and reliable async execution in Node.js/TypeScript applications.'
---
