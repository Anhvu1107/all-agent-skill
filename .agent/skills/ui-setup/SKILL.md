---
name: ui-setup
description: 'ALWAYS use this when the request matches UI Setup: Interactive StyleSeed setup wizard for choosing app type, brand color, visual style, typography, and the first screen scaffold.'
---
