...
Use this file before doing substantive work with `terraform-module-library`.

## Trigger Summary

ALWAYS use this when the request matches Terraform Module Library: Production-ready Terraform module patterns for AWS, Azure, and GCP infrastructure.
