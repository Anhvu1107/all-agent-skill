...
description: 'ALWAYS use this when the request matches Github Automation: Automate GitHub repositories, issues, pull requests, branches, CI/CD, and permissions via Rube MCP (Composio).'
---
