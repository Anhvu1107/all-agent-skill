---
name: blueprint
description: 'ALWAYS use this when the request matches Blueprint: Turn a one-line objective into a step-by-step construction plan any coding agent can execute cold.'
---
