...
description: 'ALWAYS use this when the request matches Zendesk Automation: Automate Zendesk tasks via Rube MCP (Composio): tickets, users, organizations, replies.'
---
