...
`libreoffice-calc` is a namespace-preserving alias for canonical skill `calc`.
...
- Canonical target folder: `.agent/skills/calc/`
- Canonical display name: Calc
- Alias display name: Libreoffice Calc
