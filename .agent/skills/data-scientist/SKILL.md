---
name: data-scientist
description: 'ALWAYS use this when the request matches Data Scientist: Expert data scientist for advanced analytics, machine learning, and statistical modeling.'
---
