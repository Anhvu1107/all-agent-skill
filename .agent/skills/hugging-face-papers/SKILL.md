...
description: 'ALWAYS use this when the request matches Hugging Face Papers: Read and analyze Hugging Face paper pages or arXiv papers with markdown and papers API metadata.'
---
