...
Use this file before doing substantive work with `swiftui-view-refactor`.

## Trigger Summary

ALWAYS use this when the request matches Swiftui View Refactor: Refactor SwiftUI views into smaller components with stable, explicit data flow.
