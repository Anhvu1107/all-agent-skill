---
name: seaborn
description: 'ALWAYS use this when the request matches Seaborn: Seaborn is a Python visualization library for creating publication-quality statistical graphics.'
---
