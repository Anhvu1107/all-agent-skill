...
description: 'ALWAYS use this when the request matches Azure AI Textanalytics PY: Azure AI Text Analytics SDK for sentiment analysis, entity recognition, key phrases, language detection, PII, and healthcare NLP.'
---
