---
name: network-101
description: 'ALWAYS use this when the request matches Network 101: Configure and test common network services (HTTP, HTTPS, SNMP, SMB) for penetration testing lab environments.'
---
