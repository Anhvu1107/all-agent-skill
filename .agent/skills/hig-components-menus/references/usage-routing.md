...
Use this file before doing substantive work with `hig-components-menus`.

## Trigger Summary

ALWAYS use this when the request matches HIG Components Menus: Check for .claude/apple-design-context.md before asking questions.
