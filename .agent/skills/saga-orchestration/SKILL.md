...
description: 'ALWAYS use this when the request matches Saga Orchestration: Patterns for managing distributed transactions and long-running business processes.'
---
