...
Use this file before doing substantive work with `stability-ai`.

## Trigger Summary

ALWAYS use this when the request matches Stability AI: Geracao de imagens via Stability AI (SD3.5, Ultra, Core).
