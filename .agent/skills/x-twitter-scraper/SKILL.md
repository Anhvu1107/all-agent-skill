...
description: 'ALWAYS use this when the request matches X Twitter Scraper: X (Twitter) data platform skill — tweet search, user lookup, follower extraction, engagement metrics, giveaway draws, monitoring, webhooks, 19 extraction tools, MCP server.'
---
