---
name: firebase
description: 'ALWAYS use this when the request matches Firebase: Firebase gives you a complete backend in minutes - auth, database, storage, functions, hosting.'
---
