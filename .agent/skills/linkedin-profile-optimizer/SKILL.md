...
description: 'ALWAYS use this when the request matches Linkedin Profile Optimizer: High-intent expert for LinkedIn profile checks, authority building, and SEO optimization.'
---
