---
name: mcp-builder-ms
description: 'ALWAYS use this when the request matches MCP Builder MS: Use this skill when building MCP servers to integrate external APIs or services, whether in Python (FastMCP) or Node/TypeScript (MCP SDK).'
---
