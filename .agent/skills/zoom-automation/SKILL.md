...
description: 'ALWAYS use this when the request matches Zoom Automation: Automate Zoom meeting creation, management, recordings, webinars, and participant tracking via Rube MCP (Composio).'
---
