---
name: remotion
description: 'ALWAYS use this when the request matches Remotion: Generate walkthrough videos from Stitch projects using Remotion with smooth transitions, zooming, and text overlays'
---
