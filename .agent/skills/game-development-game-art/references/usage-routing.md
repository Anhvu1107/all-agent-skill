...
Use this file before doing substantive work with `game-development-game-art`.

## Trigger Summary

ALWAYS use this when the user or an upstream archive refers to `game-development-game-art`, the nested skill path form for `game-art`, or the equivalent slash path. This is a namespace-preserving alias that routes to `game-art` while retaining strict validation, Senior Master execution, and Codex review standards.
