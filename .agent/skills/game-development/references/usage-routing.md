...
Use this file before doing substantive work with `game-development`.

## Trigger Summary

ALWAYS use this when the task is broadly about game development and you need to route by platform, engine, subsystem, or game-production concern before diving into implementation.
