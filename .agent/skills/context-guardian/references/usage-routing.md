...
Use this file before doing substantive work with `context-guardian`.

## Trigger Summary

ALWAYS use this when the request matches Context Guardian: Guardiao de contexto que preserva dados criticos antes da compactacao automatica.
