...
description: 'ALWAYS use this when the request matches HIG Project Context: Create or update a shared Apple design context document that other HIG skills use to tailor guidance.'
---
