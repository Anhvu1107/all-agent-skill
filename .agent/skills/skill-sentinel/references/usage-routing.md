...
Use this file before doing substantive work with `skill-sentinel`.

## Trigger Summary

ALWAYS use this when the request matches Skill Sentinel: Auditoria e evolucao do ecossistema de skills.
