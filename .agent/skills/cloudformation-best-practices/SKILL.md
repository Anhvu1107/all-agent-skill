...
description: 'ALWAYS use this when the request matches Cloudformation Best Practices: CloudFormation template optimization, nested stacks, drift detection, and production-ready patterns.'
---
