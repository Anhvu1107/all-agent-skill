...
description: 'ALWAYS use this when the request matches Framework Migration Deps Upgrade: You are a dependency management expert specializing in safe, incremental upgrades of project dependencies.'
---
