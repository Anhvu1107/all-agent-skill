...
description: 'ALWAYS use this when the request matches Claude IN Chrome Troubleshooting: Diagnose and fix Claude in Chrome MCP extension connectivity issues.'
---
