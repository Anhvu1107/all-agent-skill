...
Use this file before doing substantive work with `cpp-pro`.

## Trigger Summary

ALWAYS use this when the request matches CPP PRO: Write idiomatic C++ code with modern features, RAII, smart pointers, and STL algorithms.
