...
description: 'ALWAYS use this when the request matches Android UI Verification: Automated end-to-end UI testing and verification on an Android Emulator using ADB.'
---
