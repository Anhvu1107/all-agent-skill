---
name: fp-refactor
description: 'ALWAYS use this when the request matches FP Refactor: Comprehensive guide for refactoring imperative TypeScript code to fp-ts functional patterns'
---
