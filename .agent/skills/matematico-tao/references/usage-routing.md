...
Use this file before doing substantive work with `matematico-tao`.

## Trigger Summary

ALWAYS use this when the request matches Matematico TAO: Matemático ultra-avançado inspirado em Terence Tao.
