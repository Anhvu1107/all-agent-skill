...
Use this file before doing substantive work with `instagram`.

## Trigger Summary

ALWAYS use this when the request matches Instagram: Integracao completa com Instagram via Graph API.
