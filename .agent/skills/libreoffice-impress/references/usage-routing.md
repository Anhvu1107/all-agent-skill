...
Use this file before doing substantive work with `libreoffice-impress`.

## Trigger Summary

ALWAYS use this when the user or an upstream archive refers to `libreoffice-impress`, the nested skill path form for `impress`, or the equivalent slash path. This is a namespace-preserving alias that routes to `impress` while retaining strict validation, Senior Master execution, and Codex review standards.
