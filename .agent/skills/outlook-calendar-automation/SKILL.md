...
description: 'ALWAYS use this when the request matches Outlook Calendar Automation: Automate Outlook Calendar tasks via Rube MCP (Composio): create events, manage attendees, find meeting times, and handle invitations.'
---
