---
name: multi-advisor
description: 'ALWAYS use this when the request matches Multi Advisor: Conselho de especialistas — consulta multiplos agentes do ecossistema em paralelo para analise multi-perspectiva de qualquer topico.'
---
