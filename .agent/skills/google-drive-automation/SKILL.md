...
description: 'ALWAYS use this when the request matches Google Drive Automation: Lightweight Google Drive integration with standalone OAuth authentication.'
---
