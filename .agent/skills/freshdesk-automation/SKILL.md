...
description: 'ALWAYS use this when the request matches Freshdesk Automation: Automate Freshdesk helpdesk operations including tickets, contacts, companies, notes, and replies via Rube MCP (Composio).'
---
