...
description: 'ALWAYS use this when the request matches Comprehensive Review PR Enhance: Generate structured PR descriptions from diffs, add review checklists, risk assessments, and test coverage summaries.'
---
