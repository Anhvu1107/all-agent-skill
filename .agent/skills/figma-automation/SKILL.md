...
description: 'ALWAYS use this when the request matches Figma Automation: Automate Figma tasks via Rube MCP (Composio): files, components, design tokens, comments, exports.'
---
