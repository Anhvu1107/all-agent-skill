...
Use this file before doing substantive work with `web-scraper`.

## Trigger Summary

ALWAYS use this when the request matches WEB Scraper: Web scraping inteligente multi-estrategia.
