...
description: 'ALWAYS use this when the request matches React Flow Node TS: Create React Flow node components following established patterns with proper TypeScript types and store integration.'
---
