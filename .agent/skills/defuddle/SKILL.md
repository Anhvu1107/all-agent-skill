---
name: defuddle
description: 'ALWAYS use this when the request matches Defuddle: Extract clean markdown content from web pages using Defuddle CLI, removing clutter and navigation to save tokens.'
---
