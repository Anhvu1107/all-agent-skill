...
description: 'ALWAYS use this when the request matches Microsoft Teams Automation: Automate Microsoft Teams tasks via Rube MCP (Composio): send messages, manage channels, create meetings, handle chats, and search messages.'
---
