---
name: minimalist-ui
description: 'ALWAYS use this when the request matches Minimalist UI: Use when creating clean editorial interfaces with warm monochrome palettes, crisp borders, restrained motion, and flat bento layouts.'
---
