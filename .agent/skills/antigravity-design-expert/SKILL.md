...
description: 'ALWAYS use this when the request matches Antigravity Design Expert: Core UI/UX engineering skill for building highly interactive, spatial, weightless, and glassmorphism-based web interfaces using GSAP and 3D CSS.'
---
