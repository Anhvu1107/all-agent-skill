...
description: 'ALWAYS use this when the request matches API Endpoint Builder: Builds production-ready REST API endpoints with validation, error handling, authentication, and documentation.'
---
