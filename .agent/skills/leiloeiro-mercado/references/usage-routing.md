...
Use this file before doing substantive work with `leiloeiro-mercado`.

## Trigger Summary

ALWAYS use this when the request matches Leiloeiro Mercado: Analise de mercado imobiliario para leiloes.
