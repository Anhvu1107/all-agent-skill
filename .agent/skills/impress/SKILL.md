---
name: impress
description: 'ALWAYS use this when the request matches Impress: Presentation creation, format conversion (ODP/PPTX/PDF), slide automation with LibreOffice Impress.'
---
