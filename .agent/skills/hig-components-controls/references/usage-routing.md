...
Use this file before doing substantive work with `hig-components-controls`.

## Trigger Summary

ALWAYS use this when the request matches HIG Components Controls: Check for .claude/apple-design-context.md before asking questions.
