---
name: laravel-expert
description: 'ALWAYS use this when the request matches Laravel Expert: Senior Laravel Engineer role for production-grade, maintainable, and idiomatic Laravel solutions.'
---
