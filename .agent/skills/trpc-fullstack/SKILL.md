---
name: trpc-fullstack
description: 'ALWAYS use this when the request matches Trpc Fullstack: Build end-to-end type-safe APIs with tRPC — routers, procedures, middleware, subscriptions, and Next.js/React integration patterns.'
---
