...
Use this file before doing substantive work with `xlsx`.

## Trigger Summary

ALWAYS use this when the primary input or output is a spreadsheet, workbook, CSV, or tabular deliverable that needs formulas, formatting, cleanup, recalculation, charting, or Excel-compatible output.
