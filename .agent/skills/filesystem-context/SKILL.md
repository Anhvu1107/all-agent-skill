...
description: 'ALWAYS use this when the request matches Filesystem Context: Use for file-based context management, dynamic context discovery, and reducing context window bloat.'
---
