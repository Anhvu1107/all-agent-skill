...
Use this file before doing substantive work with `game-development-2d-games`.

## Trigger Summary

ALWAYS use this when the user or an upstream archive refers to `game-development-2d-games`, the nested skill path form for `2d-games`, or the equivalent slash path. This is a namespace-preserving alias that routes to `2d-games` while retaining strict validation, Senior Master execution, and Codex review standards.
