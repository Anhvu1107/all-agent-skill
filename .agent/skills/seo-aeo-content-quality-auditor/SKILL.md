...
description: 'ALWAYS use this when the request matches SEO AEO Content Quality Auditor: Audits content for SEO and AEO performance with scored reports, severity-ranked fix lists, and projected scores after fixes.'
---
