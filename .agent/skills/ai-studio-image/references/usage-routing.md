...
Use this file before doing substantive work with `ai-studio-image`.

## Trigger Summary

ALWAYS use this when the request matches AI Studio Image: Geracao de imagens humanizadas via Google AI Studio (Gemini).
