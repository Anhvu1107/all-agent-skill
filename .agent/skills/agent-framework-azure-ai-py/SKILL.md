...
description: 'ALWAYS use this when the request matches Agent Framework Azure AI PY: Build persistent agents on Azure AI Foundry using the Microsoft Agent Framework Python SDK.'
---
