...
description: 'ALWAYS use this when the request matches Firecrawl Scraper: Deep web scraping, screenshots, PDF parsing, and website crawling using Firecrawl API.'
---
