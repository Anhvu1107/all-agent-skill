...
description: 'ALWAYS use this when the request matches Deployment Pipeline Design: Architecture patterns for multi-stage CI/CD pipelines with approval gates and deployment strategies.'
---
