...
Use this file before doing substantive work with `frontend-dev-guidelines`.

## Trigger Summary

ALWAYS use this when implementing or reviewing frontend components, pages, feature slices, data fetching, or interaction patterns in a production React and TypeScript app.
