...
description: ALWAYS use this when implementing or reviewing frontend components, pages, feature slices, data fetching, or interaction patterns in a production React and TypeScript app.
---
...
- `references/architecture-routing.md`
- `references/frontend-quality-checklist.md`

Then use the rest of the skill for the exact UI, data-flow, or performance slice in question.
