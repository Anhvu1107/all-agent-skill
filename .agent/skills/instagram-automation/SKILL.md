...
description: 'ALWAYS use this when the request matches Instagram Automation: Automate Instagram tasks via Rube MCP (Composio): create posts, carousels, manage media, get insights, and publishing limits.'
---
