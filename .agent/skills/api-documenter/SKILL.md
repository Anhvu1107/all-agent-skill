---
name: api-documenter
description: 'ALWAYS use this when the request matches API Documenter: Master API documentation with OpenAPI 3.1, AI-powered tools, and modern developer experience practices.'
---
