...
Use this file before doing substantive work with `game-development-3d-games`.

## Trigger Summary

ALWAYS use this when the user or an upstream archive refers to `game-development-3d-games`, the nested skill path form for `3d-games`, or the equivalent slash path. This is a namespace-preserving alias that routes to `3d-games` while retaining strict validation, Senior Master execution, and Codex review standards.
