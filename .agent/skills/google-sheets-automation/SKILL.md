...
description: 'ALWAYS use this when the request matches Google Sheets Automation: Lightweight Google Sheets integration with standalone OAuth authentication.'
---
