...
description: 'ALWAYS use this when the request matches Google Analytics Automation: Automate Google Analytics tasks via Rube MCP (Composio): run reports, list accounts/properties, funnels, pivots, key events.'
---
