...
Use this file before doing substantive work with `agent-orchestrator`.

## Trigger Summary

ALWAYS use this when the request matches Agent Orchestrator: Meta-skill que orquestra todos os agentes do ecossistema.
