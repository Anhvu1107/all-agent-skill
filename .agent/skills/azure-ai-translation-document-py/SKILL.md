...
description: 'ALWAYS use this when the request matches Azure AI Translation Document PY: Azure AI Document Translation SDK for batch translation of documents with format preservation.'
---
