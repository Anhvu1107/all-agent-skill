...
description: 'ALWAYS use this when the request matches Progressive Estimation: Estimate AI-assisted and hybrid human+agent development work with research-backed PERT statistics and calibration feedback loops'
---
