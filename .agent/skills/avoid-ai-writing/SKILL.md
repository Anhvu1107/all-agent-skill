...
description: 'ALWAYS use this when the request matches Avoid AI Writing: Audit and rewrite content to remove 21 categories of AI writing patterns with a 43-entry replacement table'
---
