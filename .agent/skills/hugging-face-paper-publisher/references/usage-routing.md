...
Use this file before doing substantive work with `hugging-face-paper-publisher`.

## Trigger Summary

ALWAYS use this when the request matches Hugging Face Paper Publisher: Publish and manage research papers on Hugging Face Hub.
