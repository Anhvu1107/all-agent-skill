---
name: stitch-loop
description: 'ALWAYS use this when the request matches Stitch Loop: Teaches agents to iteratively build websites using Stitch with an autonomous baton-passing loop pattern'
---
