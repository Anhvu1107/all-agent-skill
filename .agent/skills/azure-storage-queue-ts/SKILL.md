...
description: 'ALWAYS use this when the request matches Azure Storage Queue TS: Azure Queue Storage JavaScript/TypeScript SDK (@azure/storage-queue) for message queue operations.'
---
