---
name: seo-audit
description: 'ALWAYS use this when the request matches SEO Audit: Diagnose and audit SEO issues affecting crawlability, indexation, rankings, and organic performance.'
---
