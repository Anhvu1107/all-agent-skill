...
description: 'ALWAYS use this when the request matches Audit Context Building: Enables ultra-granular, line-by-line code analysis to build deep architectural context before vulnerability or bug finding.'
---
