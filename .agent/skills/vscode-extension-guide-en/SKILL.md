...
description: 'ALWAYS use this when the request matches Vscode Extension Guide EN: Guide for VS Code extension development from scaffolding to Marketplace publication'
---
