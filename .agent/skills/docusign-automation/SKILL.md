...
description: 'ALWAYS use this when the request matches Docusign Automation: Automate DocuSign tasks via Rube MCP (Composio): templates, envelopes, signatures, document management.'
---
