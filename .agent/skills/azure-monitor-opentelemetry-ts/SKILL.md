...
description: 'ALWAYS use this when the request matches Azure Monitor Opentelemetry TS: Auto-instrument Node.js applications with distributed tracing, metrics, and logs.'
---
