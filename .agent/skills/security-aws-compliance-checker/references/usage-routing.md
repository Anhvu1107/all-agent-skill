...
Use this file before doing substantive work with `security-aws-compliance-checker`.

## Trigger Summary

ALWAYS use this when the user or an upstream archive refers to `security-aws-compliance-checker`, the nested skill path form for `aws-compliance-checker`, or the equivalent slash path. This is a namespace-preserving alias that routes to `aws-compliance-checker` while retaining strict validation, Senior Master execution, and Codex review standards.
