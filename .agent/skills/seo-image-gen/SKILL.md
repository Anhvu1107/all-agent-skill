---
name: seo-image-gen
description: 'ALWAYS use this when the request matches SEO Image GEN: Generate SEO-focused images such as OG cards, hero images, schema assets, product visuals, and infographics.'
---
