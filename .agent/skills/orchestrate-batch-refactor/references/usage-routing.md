...
Use this file before doing substantive work with `orchestrate-batch-refactor`.

## Trigger Summary

ALWAYS use this when the request matches Orchestrate Batch Refactor: Plan and execute large refactors with dependency-aware work packets and parallel analysis.
