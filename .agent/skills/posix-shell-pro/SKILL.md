...
description: 'ALWAYS use this when the request matches Posix Shell PRO: Expert in strict POSIX sh scripting for maximum portability across Unix-like systems.'
---
