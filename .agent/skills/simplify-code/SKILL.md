---
name: simplify-code
description: 'ALWAYS use this when the request matches Simplify Code: Review a diff for clarity and safe simplifications, then optionally apply low-risk fixes.'
---
