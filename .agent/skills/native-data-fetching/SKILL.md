...
description: 'ALWAYS use this when the request matches Native Data Fetching: Use when implementing or debugging ANY network request, API call, or data fetching.'
---
