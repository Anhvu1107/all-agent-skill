...
description: 'ALWAYS use this when the request matches Shodan Reconnaissance: Provide systematic methodologies for leveraging Shodan as a reconnaissance tool during penetration testing engagements.'
---
