...
description: 'ALWAYS use this when the request matches Basecamp Automation: Automate Basecamp project management, to-dos, messages, people, and to-do list organization via Rube MCP (Composio).'
---
