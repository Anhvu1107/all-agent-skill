...
description: 'ALWAYS use this when the request matches Vibe Code Auditor: Audit rapidly generated or AI-produced code for structural flaws, fragility, and production risks.'
---
