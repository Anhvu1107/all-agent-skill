...
description: 'ALWAYS use this when the request matches E2e Testing Patterns: Build reliable, fast, and maintainable end-to-end test suites that provide confidence to ship code quickly and catch regressions before users do.'
---
