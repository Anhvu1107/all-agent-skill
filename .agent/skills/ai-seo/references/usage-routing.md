...
Use this file before doing substantive work with `ai-seo`.

## Trigger Summary

ALWAYS use this when the request matches AI SEO: Optimize content for AI search and LLM citations across AI Overviews, ChatGPT, Perplexity, Claude, Gemini, and similar systems.
