...
description: 'ALWAYS use this when the request matches Openclaw Github Repo Commander: 7-stage super workflow for GitHub repo audit, cleanup, PR review, and competitor analysis'
---
