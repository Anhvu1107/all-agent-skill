---
name: scanpy
description: 'ALWAYS use this when the request matches Scanpy: Scanpy is a scalable Python toolkit for analyzing single-cell RNA-seq data, built on AnnData.'
---
