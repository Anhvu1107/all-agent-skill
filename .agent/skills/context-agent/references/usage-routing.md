...
Use this file before doing substantive work with `context-agent`.

## Trigger Summary

ALWAYS use this when the request matches Context Agent: Agente de contexto para continuidade entre sessoes.
