...
description: 'ALWAYS use this when the request matches TDD Orchestrator: Master TDD orchestrator specializing in red-green-refactor discipline, multi-agent workflow coordination, and comprehensive test-driven development practices.'
---
