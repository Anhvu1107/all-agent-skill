...
Use this file before doing substantive work with `hig-platforms`.

## Trigger Summary

ALWAYS use this when the request matches HIG Platforms: Apple Human Interface Guidelines for platform-specific design.
