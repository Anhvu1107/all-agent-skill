...
Use this file before doing substantive work with `ddd-strategic-design`.

## Trigger Summary

ALWAYS use this when the request matches DDD Strategic Design: Design DDD strategic artifacts including subdomains, bounded contexts, and ubiquitous language for complex business domains.
