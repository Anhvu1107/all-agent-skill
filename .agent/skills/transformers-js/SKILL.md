...
description: 'ALWAYS use this when the request matches Transformers JS: Run Hugging Face models in JavaScript or TypeScript with Transformers.js in Node.js or the browser.'
---
