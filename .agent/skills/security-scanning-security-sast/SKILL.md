...
description: 'ALWAYS use this when the request matches Security Scanning Security Sast: Static Application Security Testing (SAST) for code vulnerability analysis across multiple languages and frameworks'
---
