...
description: 'ALWAYS use this when the request matches Clarvia AEO Check: Score any MCP server, API, or CLI for agent-readiness using Clarvia AEO (Agent Experience Optimization).'
---
