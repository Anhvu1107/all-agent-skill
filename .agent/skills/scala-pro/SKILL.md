---
name: scala-pro
description: 'ALWAYS use this when the request matches Scala PRO: Master enterprise-grade Scala development with functional programming, distributed systems, and big data processing.'
---
