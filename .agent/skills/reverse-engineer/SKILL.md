...
description: 'ALWAYS use this when the request matches Reverse Engineer: Expert reverse engineer specializing in binary analysis, disassembly, decompilation, and software analysis.'
---
