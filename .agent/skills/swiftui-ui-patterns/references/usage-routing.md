...
Use this file before doing substantive work with `swiftui-ui-patterns`.

## Trigger Summary

ALWAYS use this when the request matches Swiftui UI Patterns: Apply proven SwiftUI UI patterns for navigation, sheets, async state, and reusable screens.
