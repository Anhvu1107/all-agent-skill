...
- validate the package after editing
- preserve relationships, images, and styles
- inspect the rendered result if layout matters
- do not silently strip tracked changes unless asked
