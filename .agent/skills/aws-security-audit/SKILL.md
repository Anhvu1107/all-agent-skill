...
description: 'ALWAYS use this when the request matches AWS Security Audit: Comprehensive AWS security posture assessment using AWS CLI and security best practices'
---
