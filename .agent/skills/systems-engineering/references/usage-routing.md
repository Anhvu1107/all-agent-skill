...
Use this file before doing substantive work with `systems-engineering`.

## Trigger Summary

ALWAYS use this when the request sounds like a platform, robotics stack, digital twin, telemetry-heavy system, operator workflow, simulation-first program, or any software effort that is bigger than normal app delivery.
