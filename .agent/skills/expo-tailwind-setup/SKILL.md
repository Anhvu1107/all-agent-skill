...
description: 'ALWAYS use this when the request matches Expo Tailwind Setup: Set up Tailwind CSS v4 in Expo with react-native-css and NativeWind v5 for universal styling'
---
