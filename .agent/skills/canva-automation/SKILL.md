...
description: 'ALWAYS use this when the request matches Canva Automation: Automate Canva tasks via Rube MCP (Composio): designs, exports, folders, brand templates, autofill.'
---
