...
Use this file before doing substantive work with `finishing-a-development-branch`.

## Trigger Summary

ALWAYS use this when branch work looks complete and the next question is whether to push, open a PR, merge, keep, or safely clean up.
