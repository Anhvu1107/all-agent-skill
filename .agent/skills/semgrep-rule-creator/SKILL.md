...
description: 'ALWAYS use this when the request matches Semgrep Rule Creator: Creates custom Semgrep rules for detecting security vulnerabilities, bug patterns, and code patterns.'
---
