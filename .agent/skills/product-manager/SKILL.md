...
description: 'ALWAYS use this when the request matches Product Manager: Senior PM agent with 6 knowledge domains, 30+ frameworks, 12 templates, and 32 SaaS metrics with formulas.'
---
