---
name: tool-design
description: 'ALWAYS use this when the request matches Tool Design: Build tools that agents can use effectively, including architectural reduction patterns.'
---
