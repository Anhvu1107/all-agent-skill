...
description: 'ALWAYS use this when the request matches Infinite Gratitude: Multi-agent research skill for parallel research execution (10 agents, battle-tested with real case studies).'
---
