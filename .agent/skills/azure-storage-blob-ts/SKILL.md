...
description: 'ALWAYS use this when the request matches Azure Storage Blob TS: Azure Blob Storage JavaScript/TypeScript SDK (@azure/storage-blob) for blob operations.'
---
