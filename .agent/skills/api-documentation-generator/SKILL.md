...
description: 'ALWAYS use this when the request matches API Documentation Generator: Generate comprehensive, developer-friendly API documentation from code, including endpoints, parameters, examples, and best practices'
---
