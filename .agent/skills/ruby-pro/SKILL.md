---
name: ruby-pro
description: 'ALWAYS use this when the request matches Ruby PRO: Write idiomatic Ruby code with metaprogramming, Rails patterns, and performance optimization.'
---
