---
name: seo-dataforseo
description: 'ALWAYS use this when the request matches SEO Dataforseo: Use DataForSEO for live SERPs, keyword metrics, backlinks, competitor analysis, on-page checks, and AI visibility data.'
---
