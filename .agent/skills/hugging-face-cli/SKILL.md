...
description: 'ALWAYS use this when the request matches Hugging Face CLI: Use the Hugging Face Hub CLI (`hf`) to download, upload, and manage models, datasets, and Spaces.'
---
