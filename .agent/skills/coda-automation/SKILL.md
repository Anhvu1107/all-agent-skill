...
description: 'ALWAYS use this when the request matches Coda Automation: Automate Coda tasks via Rube MCP (Composio): manage docs, pages, tables, rows, formulas, permissions, and publishing.'
---
