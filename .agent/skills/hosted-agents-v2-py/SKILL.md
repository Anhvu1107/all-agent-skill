...
description: 'ALWAYS use this when the request matches Hosted Agents V2 PY: Build hosted agents using Azure AI Projects SDK with ImageBasedHostedAgentDefinition.'
---
