---
name: videodb-skills
description: 'ALWAYS use this when the request matches Videodb Skills: Upload, stream, search, edit, transcribe, and generate AI video and audio using the VideoDB SDK.'
---
