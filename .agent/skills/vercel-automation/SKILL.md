...
description: 'ALWAYS use this when the request matches Vercel Automation: Automate Vercel tasks via Rube MCP (Composio): manage deployments, domains, DNS, env vars, projects, and teams.'
---
