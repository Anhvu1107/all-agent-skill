...
description: 'ALWAYS use this when the request matches Context Compression: When agent sessions generate millions of tokens of conversation history, compression becomes mandatory.'
---
