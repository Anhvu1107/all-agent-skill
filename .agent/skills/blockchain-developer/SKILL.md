...
description: 'ALWAYS use this when the request matches Blockchain Developer: Build production-ready Web3 applications, smart contracts, and decentralized systems.'
---
