---
name: matplotlib
description: 'ALWAYS use this when the request matches Matplotlib: Matplotlib is Python''s foundational visualization library for creating static, animated, and interactive plots.'
---
