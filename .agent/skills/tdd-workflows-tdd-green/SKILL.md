...
description: 'ALWAYS use this when the request matches TDD Workflows TDD Green: Implement the minimal code needed to make failing tests pass in the TDD green phase.'
---
