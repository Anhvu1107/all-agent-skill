---
name: ui-review
description: 'ALWAYS use this when the request matches UI Review: Review UI code for StyleSeed design-system compliance, accessibility, mobile ergonomics, spacing discipline, and implementation quality.'
---
