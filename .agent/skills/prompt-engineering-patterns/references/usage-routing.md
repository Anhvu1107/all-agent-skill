...
Use this file before doing substantive work with `prompt-engineering-patterns`.

## Trigger Summary

ALWAYS use this when the request matches Prompt Engineering Patterns: Master advanced prompt engineering techniques to maximize LLM performance, reliability, and controllability.
