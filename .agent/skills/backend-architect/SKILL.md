...
description: 'ALWAYS use this when the request matches Backend Architect: Expert backend architect specializing in scalable API design, microservices architecture, and distributed systems.'
---
